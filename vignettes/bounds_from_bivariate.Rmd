...
if(!file.exists(here::here("vignettes_data/bivariate_bounds.Rds"))){
  ...
  # Fill up with more bounds if any of the first 10,000 had negative width.
...
We reproduce the plot of the width vs. strength, but include bounds from three real world examples. The first chunk below essentially summarizes the process laid out in `vignette("example_analysis")`
