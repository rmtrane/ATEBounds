...
description: "Obtaining bounds on the ACE using two-sample data."
...
Here we will see how bounds on the ACE behaves when derived from a single IV in two-sample data. We know that the width of the bounds is bounded above by $2\cdot (1 - ST_X)$, when monotonicity of the effect of $Z$ on both $X$ and $Y$ holds. Here, we will see through simulations, that the same seems to hold without these assumptions. 
