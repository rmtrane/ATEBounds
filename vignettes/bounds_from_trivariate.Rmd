...
ggsave(
  plot, 
  filename = here::here("figures/trivariate_bounds_plot.tiff"),
...
ggsave(
  plot = subset_plot,
  filename = here::here("figures", "trivariate_bounds_subset_plot.tiff"),
...
<!-- ggsave(plot_mono, filename = here::here("figures/trivariate_bounds_mono_plot.tiff"), -->
