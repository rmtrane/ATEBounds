...
Finally, we can combine the two before mentioned approaches: from multiple IVs, randomly choose trivariate distributions of $(X,Y|Z_j)$ that fit the bill, get the bounds, and find the intersections. 
