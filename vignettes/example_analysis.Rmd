...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        "smoking_lung_cancer_marginal_Z.eps"),
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        "smoking_lung_cancer_coefficients.eps"),
...
ggsave(
  ...
  filename = here::here("figures/example_analyses",
                        "smoking_lung_cancer_marginal_conditionals.eps"),
  dpi = 300, width = 5, height = 3
)
```
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("smoking_lung_cancer_bivariate_bounds_", smoking_experiment$id, "_", lung_cancer_experiment$id,".eps")),
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("smoking_lung_cancer_bivariate_bounds_subset_", smoking_experiment$id, "_", lung_cancer_experiment$id,".eps")),
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("smoking_lung_cancer_individual_SNPs_plot_", smoking_experiment$id, "_", lung_cancer_experiment$id,".eps")),
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("smoking_lung_cancer_individual_SNPs_plot_subset_", smoking_experiment$id, "_", lung_cancer_experiment$id,".eps")),
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("smoking_lung_cancer_intersection_bounds_plot_", smoking_experiment$id, "_", lung_cancer_experiment$id,".eps")),
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        "cholesterol_heart_attack_marginal_Z.eps"),
  dpi = 300, width = 6.5, height = 2
)
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        "cholesterol_heart_attack_coefficients.eps"),
  dpi = 300, width = 5, height = 3
)
...
ggsave(
  ...
  filename = here::here("figures/example_analyses",
                        "cholesterol_heart_attack_marginal_conditionals.eps"),
  dpi = 300, width = 5, height = 3
)
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("cholesterol_heart_attack_bivariate_bounds_", cholesterol_experiment$id, "_", heart_attack_experiment$id,".eps")),
  width = 8, height = 10, dpi = 300
)
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("cholesterol_heart_attack_bivariate_bounds_subset_", cholesterol_experiment$id, "_", heart_attack_experiment$id,".eps")),
  width = 4, height = 4, dpi = 300
)
...
ggsave(
  ...
  filename = here::here("figures/example_analyses",
                        "cholesterol_heart_attack_strength_histogram.eps"),
  dpi = 300, width = 8, height = 4
)
```
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("cholesterol_heart_attack_individual_SNPs_plot_", cholesterol_experiment$id, "_", heart_attack_experiment$id,".eps")),
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("cholesterol_heart_attack_individual_SNPs_plot_subset_", cholesterol_experiment$id, "_", heart_attack_experiment$id,".eps")),
  width = 4, height = 6, dpi = 300
)
...
ggsave(
  ...
  filename = here::here("figures/example_analyses", 
                        paste0("cholesterol_heart_attack_intersection_bounds_plot_", cholesterol_experiment$id, "_", heart_attack_experiment$id,".eps")),
  width = 8, height = 6, dpi = 300
)
