...
ggsave(plot = bounds_plot_MR,
       filename = here::here("figures/bounds_from_multiple_IV_sims_MR.eps"),
...
ggsave(plot = bounds_plot_power,
       filename = here::here("figures/bounds_from_multiple_IV_sims_power.eps"),
       dpi = 300, height = 7.5, width = 10)
```
...
ggsave(plot = bounds_plot_MR_many_weak,
       filename = here::here("figures/bounds_from_multiple_IV_sims_MR_many_weak.eps"),
       dpi = 300, height = 7.5, width = 10)
```
...
ggsave(plot = bounds_plot_power_many_weak,
       filename = here::here("figures/bounds_from_multiple_IV_sims_power_many_weak.eps"),
       dpi = 300, height = 7.5, width = 10)
```
