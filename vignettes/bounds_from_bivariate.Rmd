...
ggsave(plot = width_vs_strength,
       filename = here::here("figures", "bivariate_width_vs_strength.eps"), 
...
ggsave(plot = all_bounds_plot,
       filename = here::here("figures", "all_bivariate_bounds.eps"),
       dpi = 300, width = 4, height = 2.86)
```
...
ggsave(filename = here::here("figures/bivariate_width_vs_strength_pip.eps"),
       plot = pip_figure, 
