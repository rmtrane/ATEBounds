...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.95\textwidth]{`r here("figures/png/pip_and_coefs_vs_strength.png")`}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.95\textwidth]{`r here("figures/png/loess_power.png")`}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{`r here::here("figures/png/strength_vs_coefs_multiple_IVs.png")`}
...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=\textheight]{`r here("figures/png/bounds_from_multiple_IV_sims_MR.png")`}
...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=\textheight]{`r here("figures/png/bounds_from_multiple_IV_sims_power.png")`}
...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=\textheight]{`r here("figures/png/bounds_from_multiple_IV_sims_MR_many_weak.png")`}
...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=\textheight]{`r here("figures/png/pngbounds_from_multiple_IV_sims_power_many_weak.png")`}
...
\begin{figure}[ht]
  \center
  \includegraphics[width=\linewidth]{`r here("figures/png", "trivariate_bounds_subset_plot.png")`}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width = 0.95\textwidth]{`r here("figures/png/example_analyses/bivariate_bounds.png")`}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width = 0.95\textwidth]{`r here("figures/png/example_analyses/trivariate_bounds.png")`}
...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=\textheight]{`r here("figures/png/power.png")`}
...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=\textheight]{`r here("figures/png/bounds_from_multiple_IV_sims_power_many_weak.png")`}
  \caption{Bounds based on monte carlo integration with 1,000,000 resamples in scenario 4.}
  \label{fig:bounds_from_multiple_IV_sims_power_many_weak}
\end{sidewaysfigure}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.9\textwidth]{`r here("figures/png/example_analyses/smoking_lung_cancer_marginal_Z.png")`}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.9\textwidth]{`r here("figures/png/example_analyses/smoking_lung_cancer_coefficients.png")`}
...
\begin{sidewaysfigure}
  \center
  \includegraphics[width = \textheight]{`r here("figures/png", "example_analyses", "smoking_lung_cancer_individual_SNPs_plot_ukb-d-20116_0_ukb-d-40001_C349.png")`}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.9\textwidth]{`r here("figures/png/example_analyses/cholesterol_heart_attack_marginal_Z.png")`}
  \caption{Histograms of the marginal distribution of instruments, $P(Z = z), z=0,1,2$, estimated after preprocessing.}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.99\linewidth]{`r here("figures/png", "example_analyses", "cholesterol_heart_attack_marginal_conditionals.png")`}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.9\textwidth]{`r here("figures/png/example_analyses/cholesterol_heart_attack_coefficients.png")`}
...
\begin{figure}[ht]
  \includegraphics[width = 0.99\linewidth]{`r here("figures/png/example_analyses/cholesterol_heart_attack_bivariate_bounds_ukb-a-108_ukb-a-434.png")`}
...
\begin{sidewaysfigure}
  \center
  \includegraphics[width = \textheight]{`r here("figures/png", "example_analyses", "cholesterol_heart_attack_individual_SNPs_plot_ukb-a-108_ukb-a-434.png")`}
