...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.95\textwidth]{`r here("figures/pip_and_coefs_vs_strength.png")`}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{`r here::here("figures/strength_vs_coefs_multiple_IVs.png")`}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width = 0.95\textwidth]{`r here("figures/example_analyses/bivariate_bounds.png")`}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width = 0.95\textwidth]{`r here("figures/example_analyses/trivariate_bounds.png")`}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.9\textwidth]{`r here("figures/example_analyses/smoking_lung_cancer_marginal_Z.png")`}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.9\textwidth]{`r here("figures/example_analyses/smoking_lung_cancer_coefficients.png")`}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.9\textwidth]{`r here("figures/example_analyses/cholesterol_heart_attack_marginal_Z.png")`}
  \caption{Histograms of the marginal distribution of instruments, $P(Z = z), z=0,1,2$, estimated after preprocessing.}
...
\begin{figure}[ht]
  \center
  \includegraphics[width = 0.9\textwidth]{`r here("figures/example_analyses/cholesterol_heart_attack_coefficients.png")`}
