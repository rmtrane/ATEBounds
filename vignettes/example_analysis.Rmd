...
Similarly, we obtain outcome data: identify an appropriate study with data on depression, and create an object with the informaiton available about that study. We call this object `depression_experiment`.
